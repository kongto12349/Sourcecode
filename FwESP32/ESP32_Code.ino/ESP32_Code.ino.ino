...
const char* ssid     = "Miningfarm";            // Change this to your WiFi SSID
const char* password = "0970561317";        // Change this to your WiFi password

const char* ducouser = "kongto123499";  // Change this to your Duino-Coin username
const char* rigname  = "ESP32_015";                     // Change this if you want to display a custom rig name in the Wallet
